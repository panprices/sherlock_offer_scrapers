...
__user_agents = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36"
_user_agents = [
...
def get_user_agent():
    # Generates one of the user_agents for each day
    date_today = datetime.date.today()
    # Make an index out of month and day (01-01 = 0, 01-26 = 25 & 07-21 = 26)
    index = int(date_today.day) + int(date_today.month) - 2
    return _user_agents[index % len(_user_agents)]
    # return _user_agents[random.randint(0, len(_user_agents))]
